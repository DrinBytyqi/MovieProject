...
?>
    ...
    <div class="sidebar <?php echo $_SESSION['login'];  ?>">
        ...
        <form action="db/idex.php" method="post" id="login">
            ...
            <div class="pasregtext">
                <span><a href="forgotPassword.php"> Keni harruar fjalkalimin</a></span> | <span><a href="signup.php">Regjistrohu</a></span> |<br>
                <span><a href="db/login.txt">Shiko se kush eshte i regjistruar</a></span>
            </div>
        </form>
    </div>
